...
- **Envío seguro** de la información a una hoja de Google Sheets.
- **Almacenamiento separado**:
  - **LOGIN**: gestión de usuarios y credenciales.
  - **TARJETA CRÉDITO**: almacenamiento de datos de pagos.
- **Diseño responsive** basado en **Bootstrap 4**.
- Integración con **SweetAlert** para mensajes interactivos.
...
- **Google Apps Script** (backend y conexión con Google Sheets)
